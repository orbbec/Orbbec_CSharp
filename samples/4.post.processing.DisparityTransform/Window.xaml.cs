...
namespace Orbbec
{
    ...
    /// </summary>
    public partial class DisparityTransformWindow : Window
    {
        ...
        public DisparityTransformWindow()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                {
                    pipeline.Stop();
                    MessageBox.Show("The current device does not support DisparityTransform!", "´íÎó", MessageBoxButton.OK, MessageBoxImage.Error);
                    Environment.Exit(0);
                    return;
                }
