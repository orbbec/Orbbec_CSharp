...
namespace Orbbec
{
    ...
    /// </summary>
    public partial class SequenceIdFilterWindow : Window
    {
        ...
        public SequenceIdFilterWindow()
        {
            ...
            try
            {
                ...
                {
                    pipeline.Stop();
                    MessageBox.Show("The current device does not support SequenceIdFilter!", "´íÎó", MessageBoxButton.OK, MessageBoxImage.Error);
                    Environment.Exit(0);
                    return;
                }
